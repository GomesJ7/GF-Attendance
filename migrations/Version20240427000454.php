 ...
 */
final class Version20240427000454 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contenir (formation_id INT NOT NULL, promotion_id INT NOT NULL, INDEX IDX_3C914DFD5200282E (formation_id), INDEX IDX_3C914DFD139DF194 (promotion_id), PRIMARY KEY(formation_id, promotion_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
